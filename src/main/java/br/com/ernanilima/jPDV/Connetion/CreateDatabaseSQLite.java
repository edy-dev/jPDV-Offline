...
/**
 * Cria a base de dados utilizado pelo jPDV
 * @author Ernani Lima
 */
public class CreateDatabaseSQLite extends ConnectionSQLite {

    /**
     * Executa o metodo que verifica se a base de dados ja existe
     */
    ...
    /**
     * Verifica a existencia do banco de dados SQLite
     * Se nao existir -> cria arquivo SQlite, cria tabelas e adiciona os dados
     * Se existir -> limpa todas as tabelas e adiciona os valores padroes
     */
    ...
    /**
     * Cria tabela de produtos e de vendas realizadas
     */
    ...
    /**
     * Adiciona usuarios e parametros padroes
     */
    ...
    /**
     * Limpa todas as tabelas do banco DBJPDV
     */
    ...
    /**
     * Limpa todas as tabelas do banco PARAME
     */
